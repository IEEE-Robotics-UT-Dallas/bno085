...
#define BNO_RST_LOW()  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_RESET)
#define BNO_RST_HIGH() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET)
/* USER CODE END PD */
...
/* USER CODE BEGIN PV */
volatile uint8_t bno_int_flag = 0;
...
static void BNO_ResetPulse(void)
{
  BNO_RST_LOW();
  HAL_Delay(10);
  BNO_RST_HIGH();
